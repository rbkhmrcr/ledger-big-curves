...
def schnorr_sign(msg, seckey):
    ...
    print(type(R[0]))
    print(type(R[0]))
    state = poseidon.poseidon([x, px, py, R[0], m], state=sign_state)
...
def schnorr_verify(msg, pubkey, sig):
    ...
    (x, m) = msg
    (px, py) = P
    state = poseidon.poseidon([x, px, py, r, m], state=sign_state)
    # challenge length = 128
    e = int_from_bytes(state[:128])
...
if __name__ == '__main__':
    ...
    privKEY = random_field_elt()
    SIG = schnorr_sign(MSG, privKEY)
    ...
    msg = [25615870705115042543646988269442600291065870610810566568351522267883229178288637645455574607750193516168494708212492106060991223252842215604841819346335592341288722448465861172621202305332949789691389509124500513443739624704490, 165263992375525314283137939099243432440837431930670926230162855107585165655283990966064758496729853898257922318576908240849]
    ...
    key = b'\x03' + bytes(keyx)
    sig = bytes()
