...
io_seproxyhal_touch_approve(const bagl_element_t *e) {
  ...
  // update tx at end -- instead of comparing on ledger device we could send y^2
  // and x^3 + ax + b to computer? y^2 mod fmnt6753_modulus
  cx_math_multm(xy + fmnt6753_BYTES, gmnt6753_one.Y, gmnt6753_one.Y,
                fmnt6753_modulus, fmnt6753_BYTES);
  // x^2
